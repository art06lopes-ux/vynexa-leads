...
import { listarEmpresas, obterOpcoesDeFiltro, type Filtros as TipoFiltros } from "@/db/consultas";
...
function lerBooleano(valor: string | string[] | undefined): boolean | undefined {
...
export default async function PaginaEmpresas({ searchParams }: PageProps<"/empresas">) {
      ...
      {itens.length === 0 ? (
        <Card>
          <CardContent className="flex flex-col items-center gap-2 py-12 text-center">
            ...
            <p className="font-medium">
              {total === 0 ? "Nenhuma empresa na carteira" : "Nenhuma empresa com esses filtros"}
            </p>
        ...
        <>
          ...
          {ultimaPagina > 1 && (
            ...
            >
              <Paginacao sp={sp} pagina={pagina - 1} desabilitado={pagina <= 1} direcao="anterior" />
